 ...
 * - Compatible with react-hook-form (Controller or register)
 * - Supports error, success, and disabled states
 * - Displays optional label and hint text
 */
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    if (disabled) {
      ...
      inputClasses += ` text-success-500 border-success-400 focus:border-success-300 focus:ring-success-500/10 dark:text-success-400 dark:border-success-500`;
    } else {
